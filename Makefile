...
prefix=/home/rjc/postal/postal-0.68/debian/postal/usr
eprefix=${prefix}
...
install-bin: $(EXE) $(SEXE)
	...
	${INSTALL} -s $(SEXE) $(DESTDIR)$(eprefix)/sbin
	${INSTALL} -s $(EXE) $(DESTDIR)$(eprefix)/bin

install: install-bin
	mkdir -p $(DESTDIR)${prefix}/share/man/man8 $(DESTDIR)${prefix}/share/man/man1
	${INSTALL} -m 644 $(MAN8) $(DESTDIR)${prefix}/share/man/man8
	${INSTALL} -m 644 $(MAN1) $(DESTDIR)${prefix}/share/man/man1
